...
const RenderCity = (props) => {
    ...
    if(typeof props.Weatherplace.length !== "undefined" && props.Weatherplace.length !== ""){
        return props.Weatherplace.slice(0, 10).map((objectss,ind) =>{
...
class StationWeather extends React.Component {

    render() {

            if(typeof this.props.onWeatherplace.length !== "undefined" && this.props.onWeatherplace.length !== ""){
                return (
                    <div className = "header-top">
                        ...
                        <table className="table table-hover">
                            ...
                            <tbody>
                            <RenderCity Weatherplace={this.props.Weatherplace}></RenderCity>
                            </tbody>
                        </table>
                    </div>
                );
